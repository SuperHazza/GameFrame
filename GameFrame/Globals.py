class Globals:
    ...
    POKE_BALLS = 5
    MYSTERY_MEAT = 0
    MYSTERY_MEAT_STOCK = 0
    POKE_BALL_STOCK = 0
    CURRENT_POKEMON = "Pikachu"
    Last_Opponent_Pokemon = "Pikachu"
    Last_Grass = "Grass"
    ...
    levels = ["WelcomeScreen", "GamePlay", "Trainer_Battle_1", "Trainer_Battle_2", "Pokemon_Encounter", "GamePlay_2", "GamePlay_3", "Poke_Store", "Catch_Room"]
